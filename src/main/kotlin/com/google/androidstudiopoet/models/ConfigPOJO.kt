...
class ConfigPOJO {
    ...
    val resolvedDependencies: Map<Int, Set<Dependency>> by lazy {

        val allDependencies: MutableMap<Int, MutableSet<Dependency>> = mutableMapOf()
    ...
    private fun addDependencies(to: MutableMap<Int, MutableSet<Dependency>>, from: List<Dependency>) {
