...
class ConfigPOJO {
    ...
    val resolvedDependencies: Map<String, Set<DependencyConfig>> by lazy {

        val allDependencies: MutableMap<String, MutableSet<DependencyConfig>> = mutableMapOf()
    ...
    private fun addDependencies(to: MutableMap<String, MutableSet<DependencyConfig>>, from: List<DependencyConfig>) {
