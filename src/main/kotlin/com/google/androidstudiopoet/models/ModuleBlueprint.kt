...
data class ModuleBlueprint(val index: Int,
 ...
 "val methodToCall: List<MethodToCall>", size of those two lists should be equal,
 because first list is a name of
 module and the second is a methods to call from module.
 So if we merge those lists into a List<Dependency> where dependency contains a name
 and a method call list from
 that particular module, then we'll have a place to put more stuff for android modules,
 while keeping amount of arguments low
