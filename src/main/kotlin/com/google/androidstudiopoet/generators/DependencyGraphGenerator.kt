...
class DependencyGraphGenerator(private val fileWriter: FileWriter, private val imageWriter: ImageWriter) {
    ...
    fun generate(projectBlueprint: ProjectBlueprint) {
        ...
        DependencyImageGenerator(imageWriter).generate(projectBlueprint)
    }
