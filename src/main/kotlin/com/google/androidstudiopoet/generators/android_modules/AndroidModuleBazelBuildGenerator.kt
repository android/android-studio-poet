...
class AndroidModuleBazelBuildGenerator(val fileWriter: FileWriter) {
    fun generate(blueprint: AndroidBazelBuildBlueprint) {
    ...
    private fun androidClosure(blueprint: AndroidBazelBuildBlueprint): Closure {
    ...
    private fun defaultConfigClosure(blueprint: AndroidBazelBuildBlueprint): Closure {
    ...
    private fun buildTypesClosure(blueprint: AndroidBazelBuildBlueprint): Statement {
    ...
    private fun dependenciesClosure(blueprint: AndroidBazelBuildBlueprint): Closure {
